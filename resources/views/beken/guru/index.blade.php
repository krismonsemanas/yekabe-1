                  ...
                  @foreach($guru as $no => $guru)
                    <tr>
                      ...
                      <td class='text-center'>
                        {{$guru->periode->tahun_ajaran}} Semester {{$guru->periode->semester}}
                        <br />
                        <small><i>Dibuat pada {{$guru->created_at->format('d M Y')}}</i></small>
                      </td>
                      <td class='text-center'>{{$guru->kelas->kelas}}</td>
                      <td class='text-center'>{{$guru->mapel->mapel}}</td>
                      <td class='text-center'>{{$guru->karyawan->nama}}</td>
                      <td class='text-center'>
                        <!-- <a target="_blank" href="{{ url('manage/'.$guru->id) }}" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Lihat </a> -->
                        <a href="{{ url('manage/guru/'.$guru->id.'/edit') }}" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i></a>
