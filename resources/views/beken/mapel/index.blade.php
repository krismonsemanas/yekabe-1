...
@section('title')
  <h1>
    Mapel
    <small>Info Mapel</small>
  </h1>
@endsection

@section('breadcrumb')
  <li><a href="#"><i class="fa fa-dashboard"></i> Mapel</a></li>
  <li class="active">Info Mapel</li>
@endsection
                  ...
                  @foreach($mapel as $no => $mapel)
                    <tr>
                      ...
                      <td>
                        {{$mapel->mapel}}
                        <br />
                        <small><i>Dibuat pada {{$mapel->created_at->format('d M Y')}}</i></small>
                      </td>
                      <td class='text-center'>
                        <!-- <a target="_blank" href="{{ url('artikel/'.$mapel->id) }}" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Lihat </a> -->
                        <a href="{{ url('manage/mapel/'.$mapel->id.'/edit') }}" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i></a>
