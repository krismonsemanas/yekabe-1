...
@section('title')
  <h1>
    Siswa
    <small>Data Siswa Baru</small>
  </h1>
@endsection

@section('breadcrumb')
  <li><a href="#"><i class="fa fa-bullhorn"></i>Siswa</a></li>
  <li class="active">Data Siswa Baru</li>
@endsection
...
@section('main')
      ...
      <div class="row">
        ...
        <section class="content" >
            ...
            <!-- /.box-header -->
            <div class="box-body">
                {!! Form::open(['url' => 'manage/profil_siswa', 'files' => true]) !!}
                  @include('beken.siswa.form', ['submitButtonText' => 'Tambah Siswa Baru'])
                {!! Form::close() !!}
            </div>
            <!-- /.box-body -->
          </div>
