      ...
      <div class="row">
        ...
        <section class="content" >
            ...
            <div class="box-header">
              <h3 class="box-title">Ubah Data Sisa</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                {!! Form::model($siswa, ['method' => 'PATCH', 'action' => ['ProfilSiswaController@update', $siswa->id], 'files' => true]) !!}
                  @include('beken.siswa.form', ['submitButtonText' => 'Ubah Data Siswa'])
                {!! Form::close() !!}
            </div>
            <!-- /.box-body -->
          </div>
