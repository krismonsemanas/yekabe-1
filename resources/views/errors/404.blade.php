<html>
    <head>
        <style>
            .button {
                ...
                padding: 12px 24px;
                border: 1px solid #32b3ac;
                border-radius: 8px;
                background: #52ffff;
                background: -webkit-gradient(linear, left top, left bottom, from(#52ffff), to(#32b3ac));
                background: -moz-linear-gradient(top, #52ffff, #32b3ac);
                background: linear-gradient(to bottom, #52ffff, #32b3ac);
                -webkit-box-shadow: #55ffff 0px 0px 40px 0px;
                -moz-box-shadow: #55ffff 0px 0px 40px 0px;
                box-shadow: #55ffff 0px 0px 40px 0px;
                text-shadow: #24807b 1px 1px 1px;
            ...
            .button:hover,
            .button:focus {
                border: 1px solid #47fff6;
                background: #62ffff;
                background: -webkit-gradient(linear, left top, left bottom, from(#62ffff), to(#3cd7ce));
                background: -moz-linear-gradient(top, #62ffff, #3cd7ce);
                background: linear-gradient(to bottom, #62ffff, #3cd7ce);
                color: #ffffff;
                text-decoration: none;
            }
            .button:active {
                background: #32b3ac;
                background: -webkit-gradient(linear, left top, left bottom, from(#32b3ac), to(#32b3ac));
                background: -moz-linear-gradient(top, #32b3ac, #32b3ac);
                background: linear-gradient(to bottom, #32b3ac, #32b3ac);
            }
            .button:before{
                content:  "\0000a0";
                display: inline-block;
    ...
    <body>
    <div class="main">
        <div style="text-align:center;"><a class="button" href="/">KEMBALI KE BERANDA</a></div>
        <div>
